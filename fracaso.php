...
<body id="page-top" class="index">
  ...
  <h2><strong>Ingreso Incorrecto!</strong></h2> <center><h4>No se ha podido ingresar los datos.</h4></center>
</div>
     </div>
     </div>
          <center><a href="pantallaAltaPuesto.php"><button class="btn btn-primary active">Aceptar</button></a>
