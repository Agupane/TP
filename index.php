        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Somos una consultora de recursos humanos de vanguardia de la República Argentina, focalizada en el mercado de las TIC. <br> <b>Capital Humano </b> pone a disposición de las grandes corporaciones las mejores prácticas en procesos y provisión de servicios de  <b>Recursos Humanos</b>.</h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <p class="text-muted"> Programador | Facebook Owner </p>
                        <ul class="list-inline social-buttons">
                            <li><a href="#"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="https://www.facebook.com/zuck"><i class="fa fa-facebook"></i></a>
                            </li>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <h4>Steve Jobs</h4>
                        <p class="text-muted"> Informático | Apple Owner </p>
                        <ul class="list-inline social-buttons">
                            <li><a href="#"><i class="fa fa-twitter"></i></a>
                            </li>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <h4>Bill Gates</h4>
                        <p class="text-muted"> Informático | Windows Owner </p>
                        <ul class="list-inline social-buttons">
                            <li><a href="#"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="#"><i class="fa fa-facebook"></i></a>
